   ...
   <div class="container-fluid pt-4 px-4">
                ...
                <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <a class="btn btn-primary text-dark mb-3" href="{{ route('user.create') }}"><i class="fas fa-plus me-2"></i>Tambah Data</a>
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $user->email }}</td>
                                        <td>
                                            <a class="btn btn-sm btn-dark me-2" href="{{ route('user.edit', $user->id) }}">
                                                <i class="fas fa-edit me-1"></i>Edit
                                            </a>

                                            <button class="btn btn-sm btn-danger me-2" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $user->id }}">
