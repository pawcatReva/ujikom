...
<!-- Form Start -->
<form id="formPesanan" action="{{ route('stok.store') }}" method="post">
    @csrf
        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-6">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" name="stok" id="stok" placeholder="Masukan sisa stok saat ini" readonly>
