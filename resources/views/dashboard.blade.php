...
.counter-icon {
 ...
 <div class="carousel-header">
    ...
    <div class="counter">
        <div class="counter-icon text-light bg-hejo">
            <i class="fas fa-users"></i>
        </div>
        <div class="counter-content">
            <h3>Seller</h3>
            <div class="d-flex align-items-center justify-content-center">
                <span class="counter-value text-success" data-toggle="counter-up">377</span>
                <h4 class="text-success mb-0" style="font-weight: 600; font-size: 25px;">+</h4>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-12 col-sm-6 col-md-6 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                <div class="counter">
                    ...
                    <div class="counter-content">
                        <h3>Buyer</h3>
                        <div class="d-flex align-items-center justify-content-center">
                            <span class="counter-value text-success" data-toggle="counter-up">4.9</span>
                            <h4 class="text-success mb-0" style="font-weight: 600; font-size: 25px;">K</h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-6 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                <div class="counter">
                    ...
                    <div class="counter-content">
                        <h3>New Arrival</h3>
                        <div class="d-flex align-items-center justify-content-center">
                            <span class="counter-value text-success" data-toggle="counter-up">98</span>
                            <h4 class="text-success mb-0" style="font-weight: 600; font-size: 25px;">+</h4>
                        </div>
                    </div>
                </div>
